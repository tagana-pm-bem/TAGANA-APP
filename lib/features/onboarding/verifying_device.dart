...
class VerifyingDevicePage extends StatefulWidget {
  const VerifyingDevicePage({super.key});

  @override
  State<VerifyingDevicePage> createState() => _VerifyingDevicePageState();
}

class _VerifyingDevicePageState extends State<VerifyingDevicePage> {
  ...
  void _onConnect() {
    ...
    // TODO: mulai proses BLE discovery & device verification
  }
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  ...
                  style: TextStyle(color: AppColors.destructiveForeground, fontSize: 11),
                ),
              ),
            ],
          ),
